...
class AppConfig extends Migrator
{
    ...
    public function change()
    {
        ...
        $table
            ->addColumn('app_config_module_id', 'integer', ['limit' => 10, 'default' => 0, 'comment' => '所属设置模块'])
            ->addColumn('name', 'string', ['limit' => 50, 'default' => '', 'comment' => '名称'])
            ->addColumn('code', 'string', ['limit' => 50, 'default' => '', 'comment' => '代码'])
            ->addColumn('config', 'string', ['limit' => 2000, 'default' => '', 'comment' => '设置配置'])
            ->addColumn('content', 'text', [ 'comment' => '设置内容'])
