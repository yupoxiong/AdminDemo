...
class Department extends Migrator
{
    ...
    {
        $table = $this->table('department', ['comment'=>'部门','engine' => 'InnoDB', 'encoding' => 'utf8mb4', 'collation' => 'utf8mb4_unicode_ci']);
        $table
            ->addColumn('parent_id', 'integer', ['limit' => 10, 'default' => 0, 'comment' => '上级部门'])
